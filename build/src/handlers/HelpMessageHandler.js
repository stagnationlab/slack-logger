...
var HelpMessageHandler = /** @class */ (function () {
    ...
    HelpMessageHandler.prototype.handleMessage = function (_message, logger) {
        return __awaiter(this, void 0, void 0, function () {
            var messageHandlers, response;
            return __generator(this, function (_a) {
                messageHandlers = logger.getMessageHandlers();
                response = messageHandlers
                    .map(function (messageHandler, index) { return "".concat(index + 1, ". *").concat(messageHandler.getName(), ":* ").concat(messageHandler.getDescription()); })
                    .join("\n");
